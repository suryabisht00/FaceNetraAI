...
export default function FaceSearch() {
  return (
    <ProtectedRoute>
      <div className="min-h-screen bg-linear-to-br from-indigo-50 via-white to-cyan-50 p-4 md:p-8">
        <div className="max-w-5xl mx-auto bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl overflow-hidden border border-white/20 mt-16">
          <Tabs defaultValue="add" className="w-full">
            <TabsList className="grid w-full grid-cols-2 bg-linear-to-r from-blue-500 to-purple-600 p-1 rounded-t-2xl">
